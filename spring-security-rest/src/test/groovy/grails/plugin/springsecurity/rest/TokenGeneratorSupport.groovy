...
trait TokenGeneratorSupport {
    ...
    SignedJwtTokenGenerator setupSignedJwtTokenGenerator() {
        ...
        return new SignedJwtTokenGenerator(defaultExpiration: 3600, jwtSecret: secret, signer: new MACSigner(secret), jwtTokenStorageService: jwtTokenStorageService, customClaimProviders: [])
    }
    ...
    EncryptedJwtTokenGenerator setupEncryptedJwtTokenGenerator() {
        ...
        return new EncryptedJwtTokenGenerator(defaultExpiration: 3600, jwtTokenStorageService: jwtTokenStorageService, keyProvider: keyProvider, customClaimProviders: [])
    }
